...
// MCI.cpp: Definiert das Klassenverhalten für die Anwendung.
//
...
BEGIN_MESSAGE_MAP(CMCIApp, CWinApp)
...
// Das einzige CMCIApp-Objekt

CMCIApp theApp;


// CMCIApp-Initialisierung

BOOL CMCIApp::InitInstance()
{
